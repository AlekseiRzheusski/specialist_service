...
urlpatterns = [
    ...
    path('username/search/<str:username>/', views.room_search, name='room_search'),
    path('room/<str:room_name>/', views.room, name='room'),
    path('notificationlist/', views.NotificationsListView.as_view(), name='notification-list'),
    path('delete_notification/<int:pk>', views.delete_notification, name = 'delete-notification'),
