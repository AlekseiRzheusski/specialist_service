    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('street', models.CharField(
                    help_text='Введите адрес места работы', max_length=50, null=True)),
                ...
                ('profile_pic', models.ImageField(default='default-user-image.png', null=True,
                                                  upload_to=specialistservice.decorators.PathAndRename('./account_images'))),
            ],
            options={
                'verbose_name': 'user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('specialty', models.ForeignKey(
                    null=True, on_delete=django.db.models.deletion.CASCADE, to='specialistservice.specialty')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('specialist', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, to='specialistservice.specialist')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                                 related_name='creator_of_room', related_query_name='creators_of_rooms', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('message', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, to='specialistservice.message')),
                ('user', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to='specialistservice.privateroom'),
        ),
        migrations.CreateModel(
            name='Comment',
            fields=[
                ...
                ('comment', models.TextField(
                    help_text='Введите комментарий', max_length=1000)),
                ('specialist', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, to='specialistservice.specialist')),
                ('user', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
        ...
        migrations.AddField(
            ...
            name='city',
            field=models.ForeignKey(
                null=True, on_delete=django.db.models.deletion.CASCADE, to='specialistservice.city'),
        ),
        migrations.AddField(
            model_name='user',
            name='groups',
